  ...
  return (
    <div className='flex w-[320px] flex-shrink-0 flex-col rounded-2xl border border-white/20 bg-white/10 p-5 text-white shadow-2xl backdrop-blur-xl'>
            <div className='flex justify-between items-center'>
                <h3 className='rounded-lg bg-rose-500/30 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-rose-100'>{data.category}</h3>
            ...
            <div className='mt-6'>
                <button className='w-full rounded-lg bg-rose-500 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-rose-400'>Failed</button>
            </div>
        </div>
  )
}
